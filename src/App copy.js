                              ...
                              <Button
                                ...
                                onClick={() => {
                                  if (count === 1) {
                                    axios
                                      .get(
                                        "https://junasman.github.io/prefinal/img/json/veggie2.json",
                                    ...
                                    axios
                                      .get(
                                        "https://junasman.github.io/prefinal/img/json/veggie3.json",
                    ...
                    {fruit
                      .filter(
                        (item) =>
                          item.title
                            .toLowerCase()
                            .includes(input.toLowerCase()), // 제목 검색
                      )
                      .map((ele, i) => (
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (count == 1) {
                            axios
                              .get(
                                "https://ehdnswk93.github.io/fruits/img/json/veggie2.json",
                              )
                              .then((result) => {
                            ...
                            axios
                              .get(
                                "https://ehdnswk93.github.io/fruits./img/json/veggie3.json",
                              )
                              .then((result) => {
